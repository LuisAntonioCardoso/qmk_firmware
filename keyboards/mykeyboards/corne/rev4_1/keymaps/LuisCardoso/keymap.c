...
enum custom_keycodes {
    ...
    // US International dead-key workarounds (literal characters)
    CKC_ACUT, // '´' (acute accent) — taps KC_QUOT twice
    CKC_QUOT, // ''' (apostrophe)   — taps KC_QUOT then KC_SPC
    CKC_GRV,  // '`' (grave accent) — taps KC_GRV then KC_SPC
    CKC_DQUO  // '"' (double quote) — taps S(KC_QUOT) then KC_SPC
};
...
//  .----------------------------------------------------------------------------------------------------.     .-------------------------------------------------------------------------------------------------.
       CKC_BSD    ,    KC_Q     ,    KC_W     ,    KC_E     ,    KC_R     ,    KC_T     ,    KC_NO     ,/*    */   KC_TRNS   ,    KC_Y     ,    KC_U     ,    KC_I     ,    KC_O     ,    KC_P     ,   KC_SCLN   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+---------------|     |-------------+-------------+-------------+-------------+-------------+-------------+-------------|
        KC_TAB    , LT(SMB, KC_A), LSFT_T(KC_S), LALT_T(KC_D), LCTL_T(KC_F),    KC_G     ,    KC_NO     ,/*   */   KC_TRNS   ,    KC_H     , LCTL_T(KC_J), LALT_T(KC_K), LSFT_T(KC_L),LT(COD,KC_SCLN),  CKC_BSD   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+--------------´      `-------------+-------------+-------------+-------------+-------------+-------------+-------------|
        KC_ESC    ,     KC_Z     ,    KC_X     ,    KC_C     ,    KC_V     ,    KC_B     ,/*                                */    KC_N     ,    KC_M     ,   KC_COMM    ,   KC_DOT    ,  CKC_QUOT   ,   KC_ESC    ,
//  `------------------------------------------+-------------+-------------+--------------|                                  |-------------+-------------+-------------+-----------------------------------------´
                                                     LTL     ,     LTM     ,     LTR     ,/*                                */     RTL     ,     RTM     ,     RTR     )
//                                              `----------------------------------------´                                   `----------------------------------------´
// ===================================================================================================================================================================================================================
     ...
     *                                               .-------------------------------------------------------.    .-------------------------------------------------------.
     *                                               |BspDel |   T   |   Q   |   O   |   U   |   B   |   G   |    | VOLU  |   K   |   G   |   L   |   W   |   NO  | SCLN  |
     *                                               |-------+-------+-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------+-------+-------|
     *                                               |  TAB  | C/SFT |   S   |   E   |   A   |   I   |   P   |    | VOLD  |   D   | T/CTL | R/ALT | N/SFT | H/COD |BspDel |
     *                                               |-------+-------+-------+-------+-------+-------+-------'    '-------|-------+-------+-------+-------+-------+-------|
     *                                               |  ESC  |COM/CTL|   Z   |   X   |   Y   |   J   |                    |   F   |   M   |   V   |   P   |  DOT  |  ESC  |
     *                                               '-----------------------+-------+-------+-------|                    |-------+-------+-------+-----------------------'
     *                                                                       | L/A+S |   M   | R/ALT |                    |  NO   |SPC/ARW|  NO   |
     *                                                                       '-----------------------'                    '-----------------------'                          */
    ,[GAM] = LAYOUT_split_3x6_3_ex2(
//  .----------------------------------------------------------------------------------------------------.     .------------------------------------------------------------------------------------------------.
       CKC_BSD    ,    KC_T     ,    KC_Q     ,    KC_O     ,    KC_U     ,    KC_B     ,     KC_G     ,/*   */   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,
//  |-------------+-------------+-------------+-------------+-------------+-------------+---------------|     |-------------+-------------+-------------+-------------+-------------+-------------+-------------|
        KC_TAB    ,LSFT_T(KC_C) ,    KC_S     ,    KC_E     ,    KC_A     ,    KC_I     ,     KC_P     ,/*   */   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,
//  |-------------+-------------+-------------+-------------+-------------+-------------+--------------´      `-------------+-------------+-------------+-------------+-------------+-------------+-------------|
        KC_ESC    ,LCTL_T(KC_COMM),  KC_Z     ,    KC_X     ,    KC_Y     ,    KC_J     ,/*                                */   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,
//  `-----------------------------------------+-------------+-------------+--------------|                                  |-------------+-------------+-------------+----------------------------------------´
                                                LSA_T(KC_L) ,    KC_M     ,LALT_T(KC_R) ,/*                                */   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   )
//                                             `----------------------------------------´                                   `----------------------------------------´
// ===================================================================================================================================================================================================================
...
//  .----------------------------------------------------------------------------------------------------.     .------------------------------------------------------------------------------------------------.
       KC_TRNS    ,    KC_NO     ,    KC_1     ,    KC_2     ,    KC_3     ,  S(KC_EQL)  ,   S(KC_8)    ,/*   */   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS  ,   KC_TRNS   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+---------------|     |-------------+-------------+-------------+-------------+-------------+------------+-------------|
       KC_TRNS    ,    KC_NO     , LSFT_T(KC_4), LALT_T(KC_5), LCTL_T(KC_6),    KC_0     ,   KC_SLSH    ,/*   */   KC_TRNS   ,   KC_TRNS   ,LCTL_T(KC_NO),LALT_T(KC_NO),LSFT_T(KC_NO),   KC_TRNS  ,   KC_TRNS   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+--------------´      `-------------+-------------+-------------+-------------+-------------+------------+-------------|
...
//  .----------------------------------------------------------------------------------------------------.     .------------------------------------------------------------------------------------------------.
       KC_TRNS    ,   KC_TRNS    ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,    KC_NO     ,/*   */   KC_TRNS   ,   KC_MINS   ,  CKC_ACUT   , S(KC_BSLS)  ,   S(KC_4)   , C(A(KC_5)) ,   KC_TRNS   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+---------------|     |-------------+-------------+-------------+-------------+-------------+------------+-------------|
       KC_TRNS    ,   KC_TRNS    ,LSFT_T(KC_NO),LALT_T(KC_NO),LCTL_T(KC_NO),   KC_TRNS   ,    KC_NO     ,/*   */   KC_TRNS   , S(KC_MINS)  ,  CKC_QUOT   ,  S(KC_7)    ,   S(KC_3)   ,   S(KC_2)  ,   KC_TRNS   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+--------------´      `-------------+-------------+-------------+-------------+-------------+------------+-------------|
       KC_TRNS    ,   KC_TRNS    ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,/*                                */  CKC_DQUO   ,   CKC_GRV   ,  S(KC_5)    ,   S(KC_8)   , S(KC_SCLN) ,   KC_TRNS   ,
//  `------------------------------------------+-------------+-------------+-------------|                                   |-------------+-------------+-------------+---------------------------------------´
                                                   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,/*                                */   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   )
//                                              `----------------------------------------´                                   `----------------------------------------´
// ===================================================================================================================================================================================================================
...
//  .----------------------------------------------------------------------------------------------------.     .------------------------------------------------------------------------------------------------.
       KC_TRNS    ,   KC_TRNS    ,   S(KC_6)   ,LSFT_T(KC_GRV),  KC_QUOT   ,  S(KC_GRV)  ,    KC_NO     ,/*   */   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS   ,   KC_TRNS  ,   KC_TRNS   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+---------------|     |-------------+-------------+-------------+-------------+-------------+------------+-------------|
       KC_TRNS    ,   KC_TRNS    ,LSFT_T(KC_NO),LALT_T(KC_NO),LCTL_T(KC_NO),   KC_TRNS   ,    KC_NO     ,/*   */   KC_TRNS   ,   KC_TRNS   ,LCTL_T(KC_LEFT),LALT_T(KC_UP),LSFT_T(KC_DOWN), KC_RGHT,   KC_TRNS   ,
//  |-------------+--------------+-------------+-------------+-------------+-------------+--------------´      `-------------+-------------+-------------+-------------+-------------+------------+-------------|
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        // --- US International dead-key literal macros ---
        case CKC_ACUT: // ´ — two taps of dead acute
            if (record->event.pressed) {
                tap_code(KC_QUOT);
                wait_ms(150);
                tap_code(KC_QUOT);
        ...
        case CKC_QUOT: // ' — dead acute + space
            if (record->event.pressed) {
                tap_code(KC_QUOT);
                tap_code(KC_SPC);
            }
        ...
        case CKC_DQUO: // " — dead diaeresis + space
            if (record->event.pressed) {
